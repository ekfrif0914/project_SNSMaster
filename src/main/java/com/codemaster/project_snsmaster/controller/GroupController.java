...
public class GroupController {
    ...
    public String gjdel(@RequestParam("mo_no") int mo_no, @RequestParam("gno") String gno) throws Exception {
    ...
    public String modnoSave(@ModelAttribute GroupPostVO gpvo, HttpSession session) throws Exception {
        gpvo.setId((String) session.getAttribute("userid"));
        System.out.println(gpvo.toString());
    ...
    public String gmjoinmod(@RequestParam("mo_no") int mo_no, Model model) throws Exception {
    ...
    public String gmjoinmodsave(@ModelAttribute G_joinVO gjvo, HttpSession session) throws Exception {
        gjvo.setId((String) session.getAttribute("userid"));
        System.out.println(gjvo.toString());
        System.out.println(gjvo.getGno());
        System.out.println(gjvo.getId());
    ...
    public String grouppost(@RequestParam("g_no") String g_no, Model model) throws Exception {
